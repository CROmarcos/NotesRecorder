        ...
        <div className='card'>
            <div className='card__title'>
                ...
                <section className='card__title-important'>
                    ...
                    {props.important ? <button className='action' onClick={() => { store.dispatch(markNote(props.noteId)); props.refresh() }}>Mark as important</button> : <button className='action' onClick={props.click}><img src={heart} alt="important note" /></button>}
                </section>
            </div>
